...
public class GameBoardCCTaxi extends GameBoard {
    public GameBoardCCTaxi() {
		super();
        ...
        Card ccCard1 = new TaxiCard( Card.TYPE_CC);
        Card ccCard2 = new TaxiCard( Card.TYPE_CC);
        Card chanceCard1 = new TaxiCard(Card.TYPE_CHANCE);
